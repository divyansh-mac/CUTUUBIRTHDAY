...
<head>
  ...
  <style>
    body,html {
      ...
      background: radial-gradient(circle at top, #0a0a2e, #000010);
    ...
    .wishes h1 {
      font-size:3em; text-shadow:0 0 15px hotpink;
      animation: glow 3s ease-in-out infinite alternate;
    }
    .wishes h2 {
      font-size:1.5em; opacity:0.9;
    }
    .wishes p {
      font-size:1.2em; opacity:0.7;
    }
    @keyframes glow {
      from { text-shadow:0 0 10px hotpink, 0 0 20px pink; }
      to { text-shadow:0 0 20px deeppink, 0 0 40px violet; }
    }
